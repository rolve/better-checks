 ...
 * IllegalAgrumentException) also ensures that such errors are not accidentally
 * caught by the client, which could turn an obvious bug in the server to a very
 * hard-to-find bug in the client.
 * 
 * @author Michael Faes
 */
